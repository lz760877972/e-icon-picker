...
const cdn = {
    ...
    css: [
        ...
        `https://unpkg.com/e-icon-picker@${getVersion("e-icon-picker")}/lib/ele/icon.css`
    ],
    // cdn的js链接
    js: [
        `https://cdn.jsdelivr.net/npm/vue@${getVersion("vue")}/dist/vue.global.js`,
        `https://unpkg.com/e-icon-picker@${getVersion("e-icon-picker")}/lib/index.umd.js`,
